        ...
        <a-layout-content>
            ...
            <div class="paramCon">
                ...
                <div class="labelSelection">
                    ...
                    <button class="labelunselected">重要神经元覆盖准则</button>
                    <button class="labelunselected">敏感神经元测试准则</button>
                    <button class="labelunselected">逻辑神经元测试准则</button>
                </div>
                <div class="funcParam">
...
export default {
    ...
    data(){
        return{
            ...
            jumpTo(){
                routes.replace('/coverage_neural')
            },
            /* 单选按钮样式 */
            radioStyle: {
                display: 'block',
