        ...
        return{
            ...
            DefenseInfo: [
                ...
                },
                {
                    ...
                    id:"Inte",
                    src: "",
                    des:"基于鲁棒性训练、对抗样本检测、对抗扰动过滤三种对抗样本防御方法综合提升模型对于不同类型对抗攻击方法的防御能力"
                },
                {
                    name: "基于类激活图的扰动过滤规则的攻防博弈",
                    id:"CAFD",
                    src: "",
                    des:"使用对抗训练的方法通过最小化对抗样本与原始数据在类激活特征空间的差异来优化模型参数，从而提升模型的对于不同攻击方法所生成对抗样本的降噪能力。"
                },
            ],
            selectedMethod:["FGSM"],
            selectedAttributes: {},
