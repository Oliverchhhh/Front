      ...
      <transition name="drop">
          ...
          <div class="dialog-content" v-if="isShow" @click.stop="_stopPropagation($event)">
              <div class="dialog_head back">
                  ...
                  <slot name="header">
                    <div class="dialog-title"><img src="../../assets/img/coverageneuralIcon.png" style="width: 50px; height: 50px;">神经层覆盖准则评估报告</div>
                  </slot>
              </div>
...
export default {
  ...
  methods: {
    ...
    resultPro(res){
        debugger;
        this.res.img_list = res.CoverageLayer.coverage_test_yz.coverage_layer;
