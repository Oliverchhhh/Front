...
export default {
  ...
  data() {
    return {
      ...
      allLimeTexts: {},
      textResultIdList: [],
      mode_value:'attack_attrbution_analysis'
    };
  },
  // updated:{},
    ...
    result(newValue, oldValue) {
      ...
      if ("tid" in newValue) {
        if(this.mode == 'attribution'){
          this.mode_value = 'attack_attrbution_analysis'
        }else{
        ...
        if ("attack_attrbution_analysis" in this.result) {
          let showresult = this.result.attack_attrbution_analysis;
  ...
  created(){
    ...
    this.attackMethods = this.postdata.AdvMethods
    if("attack_attrbution_analysis" in this.result){
      if("adv_ex" in  this.result.attack_attrbution_analysis){
