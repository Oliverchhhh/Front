      ...
      <transition name="drop">
          ...
          <div class="dialog-content" v-if="isShow" @click.stop="_stopPropagation($event)">
              <div class="dialog_head back">
                  ...
                  <slot name="header">
                    <div class="dialog-title"><img src="../../assets/img/coverageneuralIcon.png" style="width: 50px; height: 50px;">重要神经元覆盖准则评估报告</div>
                  </slot>
              </div>
                  ...
                  <slot name="main">
                    ...
                    <div class="result_div">
                        <div class="conclusion_info">
                            ...
                            <p class="result_annotation">重要神经元数量：{{ postData.n_imp }}</p>
                            <p class="result_annotation">聚类数：{{ postData.clus }}</p>
                        </div>
...
export default {
  ...
  methods: {
    ...
    resultPro(res){
        debugger;
        this.res.Coverage = res.CoverageImportance.ImportanceNeuronsCoverage.Coverage;
        this.res.data = res.CoverageImportance.ImportanceNeuronsCoverage.reldraw.reldraw;
        console.log('data:',this.res.data)
        drawImportanceCoverage("result_echart", this.res.data);
    },
    play:function(){
